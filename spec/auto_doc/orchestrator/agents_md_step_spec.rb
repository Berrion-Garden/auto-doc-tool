...
RSpec.describe AutoDoc::Orchestrator::AgentsMdStep do
  ...
  describe "#run" do
    it "passes config to AgentsMdGenerator.generate" do
      ...
      expect(AutoDoc::Generator::AgentsMdGenerator).to receive(:generate) do |dir_name, tree_text, files_data, config:, output_path: nil|
    ...
    it "passes the correct output_path to AgentsMdGenerator.generate" do
      ...
      expect(AutoDoc::Generator::AgentsMdGenerator).to receive(:generate) do |dir_name, tree_text, files_data, config: nil, output_path:|
